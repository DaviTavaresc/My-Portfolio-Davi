...
const Work = () => {
  ...
  <div className='container mx-auto'>
    ...
    <div>
      ...
      Along my trajectory as a developer , these are some of my projects that are being developed , They were developed with React js , Node Js , Mongodb , React Native
      </p>
    ...
    <img className='group-hover:scale-125 transition-all duration-500'  src={Img2} alt=''/>
       ...
       <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'>
        ...
        <span className='text-3x1 text-white'>BarberTime Dashboard</span>
        </div>
